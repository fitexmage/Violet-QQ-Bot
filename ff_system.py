    ...
    def reply_group_cmd_msg(self, context, command):
        ...
        if command == 'help':
            ...
            if par_list[1] in FISH_POS:
                reply = generate_image_cq('file:///Z:\\home\\user\\coolq\\data\\image\\fish_map\\{}.jpg'.format(par_list[1]))
            elif par_list[1] in FISH_MAP_DICT:
                reply = generate_image_cq('file:///Z:\\home\\user\\coolq\\data\\image\\fish_map\\' + FISH_MAP_DICT[par_list[1]]['path'])
            else:
